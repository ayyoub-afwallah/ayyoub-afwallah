...
### 🏗️ Symfony Core
* [[RateLimiter] Add `#[RateLimit]` attribute to rate limit controllers declaratively #63907](https://github.com/symfony/symfony/pull/63907) ![](https://img.shields.io/badge/Merged-purple?style=flat-square)
...
* [[PasswordHasher] Add warning to `UserPasswordHashCommand` when pa ssing plain password as argument #64105](https://github.com/symfony/symfony/pull/64105) ![](https://img.shields.io/badge/Open-green?style=flat-square)
* [[Security] Add per-username login rate-limit to prevent brute-force attacks #64104](https://github.com/symfony/symfony/pull/64104) ![](https://img.shields.io/badge/Open-green?style=flat-square)
* [[FrameworkBundle] Fix misleading error message in debug:container #63733](https://github.com/symfony/symfony/pull/63733) ![](https://img.shields.io/badge/Open-green?style=flat-square)
### 🛠️ Maker Bundle
...
### 🤖 CarsonBot
* [Hide outdated bot comments #294](https://github.com/symfony-tools/carsonbot/pull/294) ![](https://img.shields.io/badge/Open-green?style=flat-square)
